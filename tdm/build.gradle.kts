...
plugins {
    //java
    kotlin("jvm") version "1.7.20" //"1.7.20-RC" //"1.7.10"
    application
}
group = "ru.cs.tdm"
version = "1.0-SNAPSHOT"
val junitVersion = "5.9.1" //"5.9.0-M1" //"5.8.2"
...
dependencies {
    ...
    testImplementation("org.slf4j:slf4j-simple:2.0.2") //1.7.36")  // 2.0.0-alpha7 // 1.8.0-beta4
