...
import ru.cs.tdm.pages.LoginPageS
 ...
 */
class LoginS(val driver: WebDriver) {
    ...
    private val loginPageS: LoginPageS = LoginPageS(driver)
    ...
    fun loginIn(login: String, password: String) {
        ...
        loginPageS.inputLogin(login)
        //вводим пароль
        loginPageS.inputPasswd(password)
