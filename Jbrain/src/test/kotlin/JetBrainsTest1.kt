...
class JetBrainsTest1 {
    ...
    @BeforeEach
    fun setUp1() {
        println("Начало функции BeforeEach1")
        ...
        println("Конец функции BeforeEach1")
    }

//    @RepeatedTest(3)
    @Test
    fun search1() {
        println("Начало функции search1")
    ...
    @RepeatedTest(3)
    fun navigationToAllTools1() {
        brainsPage.seeAllToolsButton.click()
        assertTrue(brainsPage.productsList.isDisplayed)
        assertEquals("All Deeloper Tools and Products by JetBrains", driver.title)
    }
    /**
    ...
    fun tearDown1() {
        driver.quit()
        println("Конец функции AfterEach1")
    }
}