...
//    @RepeatedTest(3)
    ...
    println("Конец функции search1")
    softly.assertThat("Selnium").isEqualTo(brainsPage.searchPageField.getAttribute("value"))
    println("Конец функции search2")
    softly.assertThat("Selnium").isEqualTo(brainsPage.searchPageField.getAttribute("value"))
    println("Конец функции search3")
    softly.assertThat("Seleium").isEqualTo(brainsPage.searchPageField.getAttribute("value"))
    println("Конец функции search4")
    softly.assertThat("Selenium").isEqualTo(brainsPage.searchPageField.getAttribute("value"))
    println("Конец функции search5")
    softly.assertThat("Selenum").isEqualTo(brainsPage.searchPageField.getAttribute("value"))
