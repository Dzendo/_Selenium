...
// задержки : 0- все сбоят 100 - 1 шт 1000 - 0 шт
    ...
    fun n04_createUserTest(repetitionInfo: RepetitionInfo) {
        ...
        Thread.sleep(threadSleep)
        println("Ура заработало = ${tools.nomberTitle("window", "Редактирование пользователя")}")
    ...
    //fun n05_fillingUserTest() {
        ...
        println("Ура заработало = ${tools.nomberTitle("tdmsSelectObjectGridDialog","Выбор профиля")}")
        ...
        Thread.sleep(threadSleep)
        println("Ура заработало = ${tools.nomberTitle("messagebox", "Создание новой группы")}")
